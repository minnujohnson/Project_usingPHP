...
<img src="Apply_Indian_Passport_Online.jpg" alt="">
<img src="Apply_Indian_Passport_Online.jpg"alt="">
...
<div class="container">
   <div class="row">
       <div class="col-lg-8">
			...
			$uid=$_SESSION['uid'];
			//echo $uid;
			$sql="select * from applications where payment!='pending' and status='pending'";
			...
			while($r=mysqli_fetch_array($done))
			{
                ...
                <td><a href="farward.php?id=<?php echo $r['app_id'];?>">Farward For verification</a></td>
                </tr>
                <?php
			}
			?>
