        	...
        	<div class="navbar-header">
              ...
              <div id="main-nav" class="collapse navbar-collapse">
                <ul class="nav navbar-nav" id="mainNav">
                  <li class="active"><a href="police_home.php">Home</a></li>
...
<div class="container">
   <div class="row">
       <div class="col-lg-8">
            ...
            <td colspan="2">Privilages</td>
            </tr>
            
            <?php
			$uid=$_SESSION['uid'];
			//echo $uid;
			$sql="select * from applications where payment!='pending' and status='farwarded'";
			...
			while($r=mysqli_fetch_array($done))
			{
                ...
                <td><a href="uploads/<?php echo $r['photo'];?>">Photo</a></td>
                ...
                <td><a href="police_verify.php?id=<?php echo $r['app_id'];?>">Verification Done</a></td>
                <td><a href="police_reject.php?id=<?php echo $r['app_id'];?>">Reject</a></td>
                </tr>
                <?php
			}
			?>
