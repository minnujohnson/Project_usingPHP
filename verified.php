...
<div class="container">
   <div class="row">
       <div class="col-lg-8">
			...
			$uid=$_SESSION['uid'];
			//echo $uid;
			$sql="select * from applications where payment!='pending' and status='verified'";
			...
			while($r=mysqli_fetch_array($done))
			{
                ...
                <td><a href="print.php?id=<?php echo $r['app_id'];?>">View & print</a></td>
                </tr>
                <?php
			}
			?>
