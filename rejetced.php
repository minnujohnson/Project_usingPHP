        	...
        	<div class="navbar-header">
              ...
              <div id="main-nav" class="collapse navbar-collapse">
                <ul class="nav navbar-nav" id="mainNav">
                  ...
                  <li class="active"><a href="rejetced.php">Rejected</a></li>
...
<div class="container">
   <div class="row">
       <div class="col-lg-8">
            ...
            <td>Reject Notification</td>
            </tr>
            
            <?php
			$uid=$_SESSION['uid'];
			//echo $uid;
			$sql="select * from applications where payment!='pending' and status='rejected'";
			...
			while($r=mysqli_fetch_array($done))
			{
                ...
                <td><a href="notification.php?id=<?php echo $r['app_id'];?>">Send</a></td>
                </tr>
                <?php
			}
			?>
